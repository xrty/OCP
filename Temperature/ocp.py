...
if __name__ == "__main__":
    ...
    res = [i ** 2 for i in range(10_0000)]
    results = []
    ...
    #prediction_function = lac_prediction
    ...
    # Permute
        ...
        scores = orig_scores[perm]
        labels = orig_labels[perm]
    # Split
    ...
    ###
    df.to_csv('result/baselines_0.05.csv', index=False)
