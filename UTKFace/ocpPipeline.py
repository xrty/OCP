...
def run_pipeline(scores, labels, alpha=0.1, num_trials=10, lamda_list=None, save_dir='result0.1'):
    ...
    for lamda in lamda_list:
        ...
        ###
        csv_name = os.path.join(save_dir, f'result0.1_lamda{lamda}.csv')
...
if __name__ == "__main__":
    ...
    run_pipeline(scores, labels, alpha=0.1, num_trials=10,
                 lamda_list=[0.00011,0.00013,0.00015,0.00017,0.00019],
                 save_dir='result0.1')
